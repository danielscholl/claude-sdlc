...
"""
Health Check Script for System

⚠️  MIGRATION NOTE: This script is being migrated to the SDLC CLI tool.
    For new development, please use: sdlc health
    See sdlc/README.md for more information.
    This script remains functional for backward compatibility.

Usage:
uv run scripts/health_check.py <issue_number>
